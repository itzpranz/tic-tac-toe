...
export default function Board({onCellClick, board, disabled}: BoardProps) {
            ...
            <div className={`grid ${gridColsClass[size]} ${gapClass[size]} bg-slate-900`}>
                {board.map((value, xIndex) => {
                    return value.map((value, yIndex) => {
                        ...
                        className={`bg-slate-50 ${cellSizeClass[size]} p-2 md:p-4 flex flex-col items-center justify-center`}>
